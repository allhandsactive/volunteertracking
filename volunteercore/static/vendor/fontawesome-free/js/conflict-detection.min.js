...
(e = this),
  (t = function (e) {
    ...
    const s =
      ...
      typeof u.createElement === "function";
    const f = (~i.indexOf("MSIE") || i.indexOf("Trident/"), []);
    let d = !1;
    function m(e) {
    ...
    const y = "fa-kits-diag";
    const w = "fa-kits-node-under-test";
    const b = "data-md5";
    const x = "data-fa-detection-ignore";
    const A = "data-fa-detection-timeout";
    const T = "data-fa-detection-results-collection-max-wait";
    const D = function (e) {
    ...
    function E(e) {
      ...
      const c =
        void 0 === t
          ...
          : t;
      const n = e.initialDuration;
      const o = void 0 === n ? 1 : n;
      const r = e.maxDuration;
      const a = void 0 === r ? l.FontAwesomeDetection.timeout : r;
      const i = e.showProgress;
      const s = void 0 !== i && i;
      const f = e.progressIndicator;
    ...
    function C(e) {
      const t = e.nodesTested;
      const n = e.nodesFound;
    ...
    function F() {
      ...
      l.onmessage = function (e) {
        (l.location.origin !== "file://" && e.origin !== l.location.origin) ||
          (e &&
            e.data &&
            (e.data.type === "fontawesome-conflict"
              ? (n.conflict[e.data.md5] = e.data)
              : e.data.type === "no-conflict" &&
        ...
        for (
          var c = Array.from(u.scripts).filter(function (e) {
            ...
            e = function (e) {
              ...
              const n = u.createElement("script");
              n.setAttribute("id", w);
              const o = v(c[e]);
              n.setAttribute(b, o),
                (a[o] = c[e]),
                ...
                (n.async = !0);
              const r = u.createElement("script");
              r.setAttribute("id", y);
              const i =
                l.location.origin === "file://" ? "*" : l.location.origin;
              (r.innerText = "("
                .concat(
                  function (n, o, r) {
      ...
      const o = (function () {
        const e = Array.from(u.getElementsByTagName("link")).filter(function (
          e
        ) {
          return !e.hasAttribute(x);
        });
        const t = Array.from(u.getElementsByTagName("style")).filter(function (
          e
        ) {
          return !(
            e.hasAttribute(x) ||
        ...
        function n(e, t) {
          ...
          const o = "fa-test-icon-" + t;
          const r = u.createElement("i");
          r.setAttribute("class", "fa fa-coffee"), r.setAttribute("id", o);
          const i = u.createElement("script");
          i.setAttribute("id", y);
          const c = l.location.origin === "file://" ? "*" : l.location.origin;
          (i.innerText = "("
            .concat(
              function (n, o, r, i) {
                parent.FontAwesomeDetection.__pollUntil({
      ...
      const r = a({}, e, o);
      const i = Object.keys(e).length + Object.keys(o).length;
      const c =
    ...
    const O = l.FontAwesomeDetection || {};
    const N = a(
      {},
      {
        report: function (e) {
          ...
          const n = e.nodesFound;
          const o = {};
          for (const r in n) t.conflict[r] || t.noConflict[r] || (o[r] = n[r]);
          const i = Object.keys(t.conflict).length;
          if (i > 0) {
            console.info(
              "%cConflict".concat(i > 1 ? "s" : "", " found:"),
              "color: darkred; font-size: large"
            );
            const c = {};
            for (const a in t.conflict) {
              const s = t.conflict[a];
              c[a] = {
                tagName: s.tagName,
          ...
          const f = Object.keys(t.noConflict).length;
          if (f > 0) {
            console.info(
              "%cNo conflict"
                .concat(f > 1 ? "s" : "", " found with ")
                .concat(f == 1 ? "this" : "these", ":"),
              "color: green; font-size: large"
            );
            const l = {};
            for (const u in t.noConflict) {
              const d = t.noConflict[u];
              l[u] = {
                tagName: d.tagName,
