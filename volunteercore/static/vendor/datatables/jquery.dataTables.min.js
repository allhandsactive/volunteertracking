...
(function (h) {
      ...
      for (e = b.length - 1; e >= 0; e--) {
        ...
        for (g = q.length; f < g; f++) {
          if (typeof q[f] === "number" && q[f] >= 0) {
            ...
            d(q[f], n);
          } else if (typeof q[f] === "number" && q[f] < 0) {
            d(m.length + q[f], n);
          } else if (typeof q[f] === "string") {
            j = 0;
            for (i = m.length; j < i; j++) {
              (q[f] == "_all" || h(m[j].nTh).hasClass(q[f])) && d(j, n);
            }
          }
        }
      }
  ...
  function O(a, b, c, d) {
    ...
    const f = h.extend(!0, {}, l.models.oRow, {
      src: c ? "dom" : "data",
      idx: e,
    });
    f._aData = b;
    a.aoData.push(f);
    for (let g = a.aoColumns, j = 0, i = g.length; j < i; j++) {
      g[j].sType = null;
    }
    ...
    if (
      ...
      var b = function (a, d, e) {
        ...
        for (var g, j, i = 0, h = e.length - 1; i < h; i++) {
          if (e[i] === "__proto__" || e[i] === "constructor") {
  ...
  function Ha(a) {
    ...
    if (d || (!s && !f && !e && j == W(a) && j == n.length)) {
      for (l = 0; l < j; l++) {
        (i = ba(a, l)), i !== null && (c[i].sWidth = w(n.eq(l).width()));
      }
    } else {
  ...
  h.extend(r.prototype, {
    ...
    indexOf:
      x.indexOf ||
      function (a, b) {
        for (let c = b || 0, d = this.length; c < d; c++) {
  ...
  const bb = function (a, b, c, d, e) {
    ...
    for (h = b.length; i < h; i++) {
      j =
        b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
      m = 0;
