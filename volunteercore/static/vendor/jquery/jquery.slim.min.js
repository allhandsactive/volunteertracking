...
!(function (e, t) {
  ...
  const p = (function (n) {
    ...
    const W =
        ...
        M +
        ')*)|.*)\\)|)'
    const F = new RegExp(R + '+', 'g')
    const $ = new RegExp('^' + R + '+|((?:^|[^\\\\])(?:\\\\.)*)' + R + '+$', 'g')
    const z = new RegExp('^' + R + '*,' + R + '*')
    const _ = new RegExp('^' + R + '*([>+~]|' + R + ')' + R + '*')
    const U = new RegExp(R + '|>')
    const V = new RegExp(W)
    const X = new RegExp('^' + B + '$')
    const Q = {
      ID: new RegExp('^#(' + B + ')'),
      CLASS: new RegExp('^\\.(' + B + ')'),
      TAG: new RegExp('^(' + B + '|[*])'),
    ...
    const Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/
    const ee = /[+~]/
    const te = new RegExp('\\\\[\\da-fA-F]{1,6}' + R + '?|\\\\([^\\r\\n\\f])', 'g')
    ...
    function se (t, e, n, r) {
      ...
      if (!r && (C(e), (e = e || T), E)) {
        ...
        if (
          ...
          if (((c = t), (f = e), d === 1 && (U.test(t) || _.test(t)))) {
    ...
    (se.attr = function (e, t) {
      ...
      const n = x.attrHandle[t.toLowerCase()]
      let r = n && L.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !E) : void 0
      return void 0 !== r
        ? r
        : p.attributes || !E
          ? e.getAttribute(t)
          ...
          CHILD: function (h, e, t, g, v) {
            ...
            return g === 1 && v === 0
              ...
              : function (e, t, n) {
                ...
                const f = b && e.nodeName.toLowerCase()
                const d = !n && !b
                let p = !1
                if (c) {
                  if (y) {
    ...
    { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })) { x.pseudos[e] = pe(e) }
    ...
    function Te (p, h, g, v, y, e) {
      return (
        ...
        le(function (e, t, n, r) {
          ...
          const f = !p || (!e && h) ? c : Ce(c, s, p, n, r)
          let d = g ? (y || (e ? p : l || v) ? [] : t) : f
          if ((g && g(f, d, n, r), v)) {
          ...
          if (!a) {
            ...
            (a = S(
              ...
              (r = function (e, t, n, r, i) {
                ...
                let f = []
                const d = w
                const p = e || (b && x.find.TAG('*', i))
                const h = (N += d == null ? 1 : Math.random() || 0.1)
                const g = p.length
                for (
                  i && (w = t == T || t || i);
                  l !== g && (o = p[l]) != null;
  ...
  E.fn.extend({
    ...
    is: function (e) {
      return !!D(this, typeof e === 'string' && N.test(e) ? E(e) : e || [], !1)
        .length
    }
  })
  let L
  ...
  (L = E(w))
  const q = /^(?:parents|prev(?:Until|All))/
      ...
      remove: function () {
        return (
          E.each(arguments, function (e, t) {
            let n
            while ((n = E.inArray(t, s, n)) > -1) { s.splice(n, 1), n <= l && l-- }
          }),
          this
        )
      },
  ...
  const M = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
  ...
  var $ = function (e, t, n, r, i, o, a) {
    ...
    const u = e.length
    let l = n == null
    if (T(n) === 'object') { for (s in ((i = !0), n)) $(e, t, s, n[s], !0, o, a) } else if (
      void 0 !== r &&
        ((i = !0),
        b(r) || (a = !0),
        l &&
  ...
  E.fn.extend({
    data: function (n, e) {
      ...
      if (void 0 === n) {
        if (
          this.length &&
            ((i = G.get(o)), o.nodeType === 1 && !Y.get(o, 'hasDataAttrs'))
        ) {
          t = a.length
          while (t--) {
            a[t] &&
      ...
      return (
        ...
        arguments.length < e
          ...
          : void 0 === n
            ? this
            : this.each(function () {
              const e = E.queue(this, t, n)
              E._queueHooks(this, t),
              t === 'fx' && e[0] !== 'inprogress' && E.dequeue(this, t)
            })
      )
    },
    dequeue: function (e) {
  ...
  let le
  let ce
  const fe = /^(?:checkbox|radio)$/i
  const de = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i
  const pe = /^$|^module$|\/(?:java|ecma)script/i;
  ...
  function Te (e, t, n, r, i, o) {
    let a, s
    if (typeof t === 'object') {
      for (s in (typeof n !== 'string' && ((r = r || n), (n = void 0)), t)) { Te(e, s, n, r, t[s], o) }
      return e
    }
    if (
      (r == null && i == null
        ...
        E.event.add(e, i, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              if (r.length) { (E.event.special[i] || {}).delegateType && e.stopPropagation() } else if (
                ((r = s.call(arguments)),
                Y.set(this, i, r),
                (t = o(this, i)),
                this[i](),
  ...
  (E.event = {
    ...
    add: function (t, e, n, r, i) {
      ...
      if (X(t)) {
        ...
        (a = v.handle) ||
            (a = v.handle =
              function (e) {
                return typeof E !== 'undefined' && E.event.triggered !== e.type
    ...
    dispatch: function (e) {
      ...
      const u = E.event.fix(e)
      const l = (Y.get(this, 'events') || Object.create(null))[u.type] || []
      const c = E.event.special[u.type] || {}
  ...
  const Ne = /checked\s*(?:[^=]|=\s*.checked.)/i
  const Se = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
  function ke (e, t) {
    return (
      (S(e, 'table') &&
  ...
  function qe (n, r, i, o) {
    ...
    const p = r[0]
    const h = b(p)
    if (h || (f > 1 && typeof p === 'string' && !m.checkClone && Ne.test(p))) {
  ...
  E.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = ge(c, 'script')).length > 0 && ve(a, !f && ge(e, 'script')), c
      )
    },
  ...
  E.fn.extend({
    ...
    empty: function () {
      for (var e, t = 0; (e = this[t]) != null; t++) { e.nodeType === 1 && (E.cleanData(ge(e, !1)), (e.textContent = '')) }
      return this
    },
    clone: function (e, t) {
      return (
  ...
  const Fe = w.createElement('div').style
  const $e = {}
  function ze (e) {
    const t = E.cssProps[e] || $e[e]
    return (
      t ||
      (e in Fe
        ? e
  ...
  const Xe = /^--/
  const Qe = { position: 'absolute', visibility: 'hidden', display: 'block' }
  const Ye = { letterSpacing: '0', fontWeight: '400' }
  function Ge (e, t, n) {
    const r = te.exec(t)
  ...
  function Ke (e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2) {
      ...
      r
        ? (n === 'content' && (u -= E.css(e, 'padding' + ne[a], !0, i)),
          n !== 'margin' &&
      ...
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        (o = typeof n) === 'string' &&
          ...
          ((n = (function (e, t, n, r) {
            ...
            let u = s()
            let l = (n && n[3]) || (E.cssNumber[t] ? '' : 'px')
            let c =
                e.nodeType &&
                (E.cssNumber[t] || (l !== 'px' && +u)) &&
                te.exec(E.css(e, t))
            if (c && c[3] !== l) {
              (u /= 2), (l = l || c[3]), (c = +u || 1)
              while (a--) {
  ...
  E.each(['height', 'width'], function (e, u) {
    E.cssHooks[u] = {
      ...
      set: function (e, t, n) {
        let r
        const i = He(e)
        const o = !m.scrollboxSize() && i.position === 'absolute'
        const a = (o || n) && E.css(e, 'boxSizing', !1, i) === 'border-box'
  ...
  E.each({ margin: '', padding: '', border: 'Width' }, function (i, o) {
    ...
    i !== 'margin' && (E.cssHooks[i + o].set = Ge)
  }),
  E.fn.extend({
    css: function (e, t) {
      return $(
  ...
  (_e.type = 'radio'),
  (m.radioValue = _e.value === 't')
  let Ze
  const et = E.expr.attrHandle
  E.fn.extend({
    attr: function (e, t) {
  ...
  const tt = /^(?:input|select|textarea|button)$/i
  const nt = /^(?:a|area)$/i
  function rt (e) {
  ...
  function ot (e) {
    return Array.isArray(e) ? e : (typeof e === 'string' && e.match(H)) || []
  }
  E.fn.extend({
    prop: function (e, t) {
      ...
      return typeof t === 'boolean' && a
        ...
        : b(i)
          ...
          : this.each(function () {
            ...
            } else (void 0 !== i && o !== 'boolean') || ((e = it(this)) && Y.set(this, '__className__', e), this.setAttribute && this.setAttribute('class', e || !1 === i ? '' : Y.get(this, '__className__') || ''))
          })
    },
    hasClass: function (e) {
      let t
      ...
      t = ' ' + e + ' '
      while ((n = this[r++])) {
        if (n.nodeType === 1 && (' ' + rt(it(n)) + ' ').indexOf(t) > -1) { return !0 }
      }
      return !1
    }
  })
  ...
  const st = /^(?:focusinfocus|focusoutblur)$/
  const ut = function (e) {
    e.stopPropagation()
  }
  E.extend(E.event, {
    trigger: function (e, t, n, r) {
      ...
      let f
      const d = [n || w]
      let p = y.call(e, 'type') ? e.type : e
      let h = y.call(e, 'namespace') ? e.namespace.split('.') : []
      if (
        ((o = f = a = n = n || w),
        n.nodeType !== 3 &&
          n.nodeType !== 8 &&
          ...
          ((e = e[E.expando]
            ? e
            : new E.Event(p, typeof e === 'object' && e)).isTrigger = r ? 2 : 3),
          (e.namespace = h.join('.')),
  ...
  const pt = /^(?:input|select|textarea|keygen)/i
  function ht (n, e, r, i) {
    let t
    if (Array.isArray(e)) {
      E.each(e, function (e, t) {
