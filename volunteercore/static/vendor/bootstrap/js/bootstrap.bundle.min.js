...
!(function (t, e) {
  ...
  const y = (function () {
    ...
    return (
      ...
      (e._getItemByDirection = function (t, e) {
        ...
        const a = (o + (t === 'prev' ? -1 : 1)) % this._items.length
        return a === -1
      ...
      (t._jQueryInterface = function (e) {
        return this.each(function () {
          ...
          if (
            ...
            typeof e === 'number')
          ) { n.to(e) } else if (typeof r === 'string') {
            if (typeof n[r] === 'undefined') { throw new TypeError('No method named "' + r + '"') }
            n[r]()
      ...
      (t._dataApiClickHandler = function (e) {
        ...
        if (n) {
          ...
          if (o && i.default(o).hasClass('carousel')) {
            const r = a({}, i.default(o).data(), i.default(this).data())
    ...
    return (
      ...
      (t._jQueryInterface = function (e) {
        return this.each(function () {
          ...
          const r = a({}, T, n.data(), typeof e === 'object' && e ? e : {})
          if (
            (!o &&
                r.toggle &&
                typeof e === 'string' &&
  ...
  function tt (t) {
    ...
    for (var e = t.parentElement; e && I(e, 'transform') === 'none';) { e = e.parentElement }
  ...
  const te = (function () {
    ...
    return (
      ...
      (e.show = function () {
        const t = this
        if (i.default(this.element).css('display') === 'none') { throw new Error('Please use show on visible elements') }
  ...
  const ee = 'popover'
  const ne = i.default.fn[ee]
  const ie = new RegExp('(^|\\s)bs-popover\\S+', 'g')
  const oe = a({}, te.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template:
  ...
  const re = a({}, te.DefaultType, { content: '(string|element|function)' })
  const ae = {
  ...
  const le = 'scrollspy'
  const ue = i.default.fn[le]
  const fe = { offset: 10, method: 'auto', target: '' }
  const de = { offset: 'number', method: 'string', target: '(string|element)' }
  const ce = (function () {
    function t (t, e) {
      const n = this;
      (this._element = t),
    ...
    return (
      (e.refresh = function () {
        ...
        const o = n === 'position' ? this._getScrollTop() : 0;
        (this._offsets = []),
        (this._targets = []),
