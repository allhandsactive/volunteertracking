...
!(function (t, e) {
  ...
  const m = (function () {
    ...
    return (
      (e.toggle = function () {
        let t = !0
        let e = !0
        const n = o.default(this._element).closest('[data-toggle="buttons"]')[0]
        if (n) {
  ...
  const w = (function () {
    ...
    return (
      ...
      (e._getItemByDirection = function (t, e) {
        ...
        if (((i && o === 0) || (n && o === a)) && !this._config.wrap) { return e }
      ...
      (t._jQueryInterface = function (e) {
        return this.each(function () {
          ...
          let i = r({}, b, o.default(this).data())
          typeof e === 'object' && (i = r({}, i, e))
          const a = typeof e === 'string' ? e : i.slide
          if (
            (n ||
                ((n = new t(this, i)), o.default(this).data('bs.carousel', n)),
            typeof e === 'number')
          ) { n.to(e) } else if (typeof a === 'string') {
            if (typeof n[a] === 'undefined') { throw new TypeError('No method named "' + a + '"') }
            n[a]()
      ...
      (t._dataApiClickHandler = function (e) {
        ...
        if (n) {
          ...
          if (i && o.default(i).hasClass('carousel')) {
            const a = r({}, o.default(i).data(), o.default(this).data())
  ...
  const T = 'collapse'
  const C = o.default.fn[T]
  const S = { toggle: !0, parent: '' }
  const N = { toggle: 'boolean', parent: '(string|element)' }
  const D = (function () {
    function t (t, e) {
    ...
    return (
      ...
      (t._jQueryInterface = function (e) {
        return this.each(function () {
          ...
          const a = r({}, S, n.data(), typeof e === 'object' && e ? e : {})
          if (
            (!i &&
                a.toggle &&
                typeof e === 'string' &&
  ...
  const k = 'dropdown'
  const A = o.default.fn[k]
  const I = new RegExp('38|40|27')
  const j = {
    offset: 0,
    flip: !0,
      ...
      (t._clearMenus = function (e) {
        if (!e || (e.which !== 3 && (e.type !== 'keyup' || e.which === 9))) {
          for (
            ...
            if ((e && e.type === 'click' && (r.clickEvent = e), l)) {
              const u = l._menu
              if (
  ...
  const q = (function () {
    ...
    return (
      ...
      (e._showElement = function (t) {
        ...
        const i = this._dialog ? this._dialog.querySelector('.modal-body') : null;
  ...
  const M = 'tooltip'
  const W = o.default.fn[M]
  const V = new RegExp('(^|\\s)bs-tooltip\\S+', 'g')
  const z = ['sanitize', 'whiteList', 'sanitizeFn']
  const K = {
    animation: 'boolean',
    template: 'string',
  ...
  const J = (function () {
    ...
    return (
      ...
      (e.show = function () {
        const t = this
        if (o.default(this.element).css('display') === 'none') { throw new Error('Please use show on visible elements') }
  ...
  const G = 'popover'
  const Z = o.default.fn[G]
  const tt = new RegExp('(^|\\s)bs-popover\\S+', 'g')
  const et = r({}, J.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template:
  ...
  const nt = r({}, J.DefaultType, { content: '(string|element|function)' })
  const it = {
    ...
    return (
      ...
      (i._jQueryInterface = function (t) {
        return this.each(function () {
          ...
          const n = typeof t === 'object' ? t : null
          if (
  ...
  const at = 'scrollspy'
  const st = o.default.fn[at]
  const lt = { offset: 10, method: 'auto', target: '' }
  const rt = { offset: 'number', method: 'string', target: '(string|element)' }
  const ut = (function () {
    function t (t, e) {
      const n = this;
      (this._element = t),
    ...
    return (
      ...
      (e._getConfig = function (t) {
        if (
          typeof (t = r({}, lt, typeof t === 'object' && t ? t : {}))
            .target !==
              'string' &&
    ...
    return (
      ...
      (t._jQueryInterface = function (e) {
        return this.each(function () {
          ...
          if (
            (i ||
                ((i = new t(this, typeof e === 'object' && e)),
                n.data('bs.toast', i)),
            typeof e === 'string')
          ) {
            if (typeof i[e] === 'undefined') { throw new TypeError('No method named "' + e + '"') }
