...
*/
  ...
  const element_arc = core_element.extend({
    ...
    inRange: function (chartX, chartY) {
      ...
      if (vm) {
        const pointRelativePosition = helpers$1.getAngleFromPoint(vm, {
          x: chartX,
          y: chartY,
        });
  ...
  const controller_bar = core_datasetController.extend({
    ...
    _updateElementGeometry: function (rectangle, index, reset, options) {
      ...
      const ipixels = me.calculateBarIndexPixels(
        me.index,
        index,
        ruler,
        options
  ...
  const controller_line = core_datasetController.extend({
    ...
    update: function (reset) {
      ...
      const showLine = (me._showLine = valueOrDefault$6(
        config.showLine,
        options.showLines
      ));
      let i, ilen;
  ...
  const controller_polarArea = core_datasetController.extend({
    ...
    updateElement: function (arc, index, reset) {
      ...
      const resetRadius = animationOpts.animateScale
        ? 0
        : scale.getDistanceFromCenterForValue(dataset.data[index]);
      const options = arc._options || {};
  ...
  function addResizeListener(node, listener, chart) {
    ...
    const resizer = (expando.resizer = createResizer(
      throttled(function () {
        if (expando.resizer) {
          const container =
  ...
  const implementation = platform_dom$2._enabled
    ? platform_dom$2
    : platform_basic;
  ...
  helpers$1.extend(
    ...
    /** @lends Chart */ {
      ...
      render: function (config) {
        ...
        const duration = valueOrDefault$9(
          config.duration,
  ...
  const core_helpers = function () {
    ...
    helpers$1.getMaximumWidth = function (domNode) {
      ...
      const paddingLeft = helpers$1._calculatePadding(
        container,
        "padding-left",
        clientWidth
      );
      const paddingRight = helpers$1._calculatePadding(
        container,
        "padding-right",
        clientWidth
      );
    ...
    helpers$1.getMaximumHeight = function (domNode) {
      ...
      const paddingTop = helpers$1._calculatePadding(
        container,
        "padding-top",
        clientHeight
      );
      const paddingBottom = helpers$1._calculatePadding(
        container,
        "padding-bottom",
        clientHeight
      );
  ...
  function parseTickFontOptions(options) {
    ...
    const major = options.major.enabled
  ...
  const Scale = core_element.extend({
    ...
    _drawGrid: function (chartArea) {
      ...
      if (axisWidth) {
        ...
        const lastLineWidth = valueAtIndexOrDefault(
          gridLines.lineWidth,
          items.ticksLength - 1,
          1
        );
    ...
    _drawTitle: function () {
      ...
      const scaleLabelFontColor = valueOrDefault$a(
  ...
  function drawPointLabels(scale) {
    ...
    for (let i = scale.chart.data.labels.length - 1; i >= 0; i--) {
      ...
      const pointLabelFontColor = valueAtIndexOrDefault$1(
  ...
  function drawRadiusLine(scale, gridLineOpts, radius, index) {
    ...
    const lineWidth = valueAtIndexOrDefault$1(
  ...
  const scale_radialLinear = scale_linearbase.extend({
    ...
    convertTicksToLabels: function () {
      ...
      me.pointLabels = me.chart.data.labels.map(function () {
        const label = helpers$1.callback(
    ...
    _drawGrid: function () {
      ...
      const lineWidth = valueOrDefault$c(
        angleLineOpts.lineWidth,
        gridLineOpts.lineWidth
      );
      const lineColor = valueOrDefault$c(
        angleLineOpts.color,
        gridLineOpts.color
      );
    ...
    _drawLabels: function () {
      ...
      const tickFontColor = valueOrDefault$c(
        tickOpts.fontColor,
        core_defaults.global.defaultFontColor
      );
      let offset, width;
  ...
  const scale_time = core_scale.extend({
    ...
    update: function () {
      ...
      const adapter = (me._adapter = new core_adapters._date(
    ...
    getLabelCapacity: function (exampleTime) {
      ...
      const exampleLabel = me.tickFormatFunction(
        exampleTime,
        0,
  ...
  const moment = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
      ...
      addWeekParseToken(
        ["dd", "ddd", "dddd"],
        function (input, week, config, token) {
          const weekday = config._locale.weekdaysParse(
            input,
            token,
            config._strict
          );
      ...
      const defaultLocaleWeekdaysShort = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split(
        "_"
      );
      ...
      function configFromRFC2822(config) {
        ...
        if (match) {
          const parsedArray = extractFromRFC2822Strings(
            match[4],
            match[3],
            match[2],
            match[5],
      ...
      function setWeekAll(weekYear, week, weekday, dow, doy) {
        const dayOfYearData = dayOfYearFromWeeks(
          weekYear,
          week,
          weekday,
          dow,
  ...
  const Legend = core_element.extend({
    ...
    draw: function () {
      ...
      const ctx = me.ctx;
      const fontColor = valueOrDefault$e(
        labelOpts.fontColor,
      ...
      const drawLegendBox = function (x, y, legendItem) {
        ...
        const lineWidth = valueOrDefault$e(
