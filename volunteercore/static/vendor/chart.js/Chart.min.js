...
!(function (t, e) {
    ...
    Object.keys(e).forEach(function (n) {
      ...
      (o[t][n] = (function (t) {
        const e = function (e) {
          ...
          const n = t(e);
          if (typeof n === "object") {
            for (let i = n.length, a = 0; a < i; a++) n[a] = Math.round(n[a]);
          }
          return n;
        };
      ...
      const a =
        i.barThickness === "flex"
          ? (function (t, e, n) {
              ...
              return (
                o === null && (o = r - (s === null ? e.end - e.start : s - r)),
                s === null && (s = r + r - o),
  ...
  const zn = yn.extend({
    ...
    handleTickRangeOptions: function () {
      ...
      (t.min = Rn(e.min, t.min)),
        ...
        t.max === null &&
          (t.max = t.min !== 0 ? Math.pow(10, Math.floor(On(t.min)) + 1) : 10),
        t.minNotZero === null &&
          (t.min > 0
            ? (t.minNotZero = t.min)
            : t.max < 1
      ...
      return (
        ...
        (i._majorUnit =
          s.major.enabled && i._unit !== "year"
            ? (function (t) {
                for (let e = ni.indexOf(t) + 1, n = ni.length; e < n; ++e) {
        ...
        (i._offsets = (function (t, e, n, i, a) {
          ...
          return (
            a.offset &&
              ...
              ((r = oi(t, "time", e[0], "pos")),
              (s =
                e.length === 1 ? 1 - r : (oi(t, "time", e[1], "pos") - r) / 2),
  ...
  function mi(t, e, n) {
    ...
    const a = t._model || {};
    let r = a.fill;
    if ((void 0 === r && (r = !!a.backgroundColor), !1 === r || r === null)) {
      return !1;
    }
