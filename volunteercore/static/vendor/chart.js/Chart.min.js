...
!(function (t, e) {
  ...
  const n = (function (t, e) {
    ...
    const n = {}
    for (const i in e) e.hasOwnProperty(i) && (n[e[i]] = i)
    const a = (t.exports = {
    ...
    (a.rgb.hsl = function (t) {
      ...
      const a = t[1] / 255
      const r = t[2] / 255
      const o = Math.min(i, a, r)
      const s = Math.max(i, a, r)
      const l = s - o
      return (
        s === o
          ? (e = 0)
    ...
    (a.rgb.hsv = function (t) {
      ...
      const s = t[1] / 255
      const l = t[2] / 255
      const u = Math.max(o, s, l)
      const d = u - Math.min(o, s, l)
      const h = function (t) {
        return (u - t) / 6 / d + 0.5
      }
      return (
    ...
    (a.lab.xyz = function (t) {
      ...
      const o = Math.pow(e, 3)
      const s = Math.pow(i, 3)
      return (
    ...
    (a.rgb.hcg = function (t) {
      ...
      const i = t[1] / 255
      const a = t[2] / 255
      const r = Math.max(Math.max(n, i), a)
      const o = Math.min(Math.min(n, i), a)
      const s = r - o
      return (
        (e =
              s <= 0
  ...
  function i (t) {
    ...
    for (e[t].distance = 0; i.length;) {
      for (
        let a = i.pop(), r = Object.keys(n[a]), o = r.length, s = 0;
        s < o;
        s++
      ) {
        const l = r[s]
  ...
  const u = {
    ...
    percentString: function (t, e) {
      ...
      const i = Math.round((t[1] / 255) * 100)
      const a = Math.round((t[2] / 255) * 100)
      return 'rgb(' + n + '%, ' + i + '%, ' + a + '%)'
    },
    percentaString: g,
  ...
  function d (t) {
    if (t) {
      ...
      return (n = n || n == 0 ? m(n, 0, 1) : 1), (e[3] = n), e
    }
  }
  function h (t) {
    if (t) {
  ...
  (y.prototype = {
    ...
    mix: function (t, e) {
      const n = t
      const i = void 0 === e ? 0.5 : e
      const a = 2 * i - 1
      const r = this.alpha() - n.alpha()
      const o = ((a * r == -1 ? a : (a + r) / (1 + a * r)) + 1) / 2
      const s = 1 - o
      return this.rgb(
        o * this.red() + s * n.red(),
  ...
  (y.prototype.setValues = function (t, e) {
    ...
    for (const d in r) d !== t && (a[d] = s[t][d](a[t]))
    return !0
  }),
  ...
  typeof window !== 'undefined' && (window.Color = y)
  const _ = y
  function k (t) {
  ...
  const E = {
    ...
    _parseFont: function (t) {
      const e = N.global
      const n = B(t.fontSize, e.defaultFontSize)
      const i = {
  ...
  const J = {
    ...
    cancelAnimation: function (t) {
      const e = H.findIndex(this.animations, function (e) {
        return e.chart === t
      })
  ...
  H.extend(nt.prototype, {
    ...
    buildOrUpdateElements: function () {
      ...
      let e
      const n = this
      const i = n.getDataset()
      const a = i.data || (i.data = [])
      n._data !== a &&
    ...
    _configure: function () {
      this._config = H.merge(
        ...
        {
          merger: function (t, e, n) {
            t !== '_meta' && t !== 'data' && H._merger(t, e, n)
          }
        }
      )
    },
    ...
    _resolveDatasetElementOptions: function (t, e) {
      ...
      const l = o._config
      const u = t.custom || {}
      const d = s.options.elements[o.datasetElementType.prototype._type] || {}
      const h = o._datasetElementOptions
      const c = {}
      const f = {
        chart: s,
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      const u = n.chart
      const d = n._config
      const h = u.options.elements[n.dataElementType.prototype._type] || {}
      const c = n._dataElementOptions
      const f = {}
      const g = {
        chart: u,
        dataIndex: e,
  ...
  const st = K.extend({
    ...
    inRange: function (t, e) {
      ...
      if (n) {
        ...
        for (; a < o;) a += at
        const l = a >= o && a <= s
        const u = r >= n.innerRadius && r <= n.outerRadius
        return l && u
      }
      return !1
    },
    ...
    draw: function () {
      ...
      const n = this._view
      const i = n.borderAlign === 'inner' ? 0.33 : 0
      const a = {
        x: n.x,
        y: n.y,
  ...
  const lt = H.valueOrDefault
  const ut = N.global.defaultColor
  N._set('global', {
    elements: {
      line: {
        tension: 0.4,
  ...
  const dt = K.extend({
    ...
    draw: function () {
      ...
      const i = this
      const a = i._view
      const r = i._chart.ctx
      const o = a.spanGaps
      let s = i._children.slice()
      const l = N.global
      const u = l.elements.line
      let d = -1
      let h = i._loop
      if (s.length) {
        if (i._loop) {
  ...
  const ht = H.valueOrDefault
  const ct = N.global.defaultColor
  function ft (t) {
    const e = this._view
  ...
  const gt = K.extend({
    ...
    draw: function (t) {
      ...
      const i = e.pointStyle
      const a = e.rotation
      const r = e.radius
      const o = e.x
      const s = e.y
      const l = N.global
      const u = l.defaultColor
      e.skip ||
  ...
  const pt = N.global.defaultColor
  function mt (t) {
  ...
  const Pt = H._deprecated
  const At = H.valueOrDefault
  function Dt (t, e, n) {
    let i
    let a
    const r = n.barThickness
    const o = e.stackCount
    const s = e.pixels[t]
    const l = H.isNullOrUndef(r)
      ? (function (t, e) {
          let n
          let i
          let a
  ...
  const Tt = it.extend({
    ...
    update: function (t) {
      let e
      let n
      const i = this.getMeta().data
      for (this._ruler = this.getRuler(), e = 0, n = i.length; e < n; ++e) { this.updateElement(i[e], e, t) }
    },
    updateElement: function (t, e, n) {
      const i = this
      const a = i.getMeta()
      const r = i.getDataset()
      const o = i._resolveDataElementOptions(t, e);
    ...
    _updateElementGeometry: function (t, e, n, i) {
      const a = this
      const r = t._model
      const o = a._getValueScale()
      const s = o.getBasePixel()
      const l = o.isHorizontal()
      const u = a._ruler || a.getRuler()
      const d = a.calculateBarValuePixels(a.index, e, i)
      const h = a.calculateBarIndexPixels(a.index, e, u, i);
      (r.horizontal = l),
      (r.base = n ? s : d.base),
    ...
    _getStacks: function (t) {
      let e
      let n
      const i = this._getIndexScale()
      const a = i._getMatchingVisibleMetas(this._type)
    ...
    getStackIndex: function (t, e) {
      ...
      const i = void 0 !== e ? n.indexOf(e) : -1
      return i === -1 ? n.length - 1 : i
    },
    getRuler: function () {
      let t
      let e
      const n = this._getIndexScale()
      const i = []
    ...
    calculateBarValuePixels: function (t, e, n) {
      ...
      let u
      const d = this.chart
      const h = this._getValueScale()
      const c = h.isHorizontal()
      const f = d.data.datasets
      const g = h._getMatchingVisibleMetas(this._type)
      const p = h._parseValue(f[t].data[e])
      const m = n.minBarLength
      const v = h.options.stacked
      const b = this.getMeta().stack
      let x = void 0 === p.start ? 0 : p.max >= 0 && p.min >= 0 ? p.min : p.max
      const y =
            void 0 === p.start
              ? p.end
              : p.max >= 0 && p.min >= 0
    ...
    calculateBarIndexPixels: function (t, e, n, i) {
      const a =
            i.barThickness === 'flex'
              ...
              : Dt(e, n, i)
      const r = this.getStackIndex(t, this.getMeta().stack)
      const o = a.start + a.chunk * r + a.chunk / 2
      const s = Math.min(At(i.maxBarThickness, 1 / 0), a.chunk * a.ratio)
      return { base: o - s / 2, head: o + s / 2, center: o, size: s }
    },
    draw: function () {
      const t = this.chart
      const e = this._getValueScale()
    ...
    _resolveDataElementOptions: function () {
      ...
      const n = t._getIndexScale().options
      const i = t._getValueScale().options
      return (
  ...
  const It = H.valueOrDefault
  const Ft = H.options.resolve
  N._set('bubble', {
    hover: { mode: 'single' },
    scales: {
  ...
  const Ot = it.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      const a = i.getMeta()
      const r = t.custom || {}
      const o = i.getScaleForId(a.xAxisID)
      const s = i.getScaleForId(a.yAxisID)
      const l = i._resolveDataElementOptions(t, e)
      const u = i.getDataset().data[e]
      const d = i.index
      const h = n
        ? o.getPixelForDecimal(0.5)
        : o.getPixelForValue(typeof u === 'object' ? u : NaN, e, d)
      const c = n ? s.getBasePixel() : s.getPixelForValue(u, e, d);
      (t._xScale = o),
      (t._yScale = s),
      (t._options = l),
      (t._datasetIndex = d),
    ...
    _resolveDataElementOptions: function (t, e) {
      ...
      const r = t.custom || {}
      const o = a.data[e] || {}
      let s = it.prototype._resolveDataElementOptions.apply(n, arguments)
      const l = { chart: i, dataIndex: e, dataset: a, datasetIndex: n.index }
      return (
        ...
        generateLabels: function (t) {
          ...
          return e.labels.length && e.datasets.length
            ? e.labels.map(function (n, i) {
              ...
              const r = a.controller.getStyle(i)
              return {
                text: n,
  ...
  const Bt = it.extend({
    ...
    update: function (t) {
      ...
      const f = r.getMeta()
      const g = f.data
      const p = l.cutoutPercentage / 100 || 0
      const m = l.circumference
      const v = r._getRingWeight(r.index)
      if (m < zt) {
        let b = l.rotation % zt
        const x = (b += b >= Rt ? -zt : b < -Rt ? zt : 0) + m
        const y = Math.cos(b)
        const _ = Math.sin(b)
        const k = Math.cos(x)
        const w = Math.sin(x)
        const M = (b <= 0 && x >= 0) || x >= zt
        const S = (b <= Nt && x >= Nt) || x >= zt + Nt
        const C = (b <= -Nt && x >= -Nt) || x >= Rt + Nt
        const P = b === -Rt || x >= Rt ? -1 : Math.min(y, y * p, k, k * p)
        const A = C ? -1 : Math.min(_, _ * p, w, w * p)
        const D = M ? 1 : Math.max(y, y * p, k, k * p)
        const T = S ? 1 : Math.max(_, _ * p, w, w * p);
        (u = (D - P) / 2),
        (d = (T - A) / 2),
        (h = -(D + P) / 2),
        (c = -(T + A) / 2)
    ...
    updateElement: function (t, e, n) {
      ...
      const o = a.options
      const s = o.animation
      const l = (r.left + r.right) / 2
      const u = (r.top + r.bottom) / 2
      const d = o.rotation
      const h = o.rotation
      const c = i.getDataset()
      const f =
          n && s.animateRotate
            ? 0
            : t.hidden
      ...
      const g = n && s.animateScale ? 0 : i.innerRadius
      const p = n && s.animateScale ? 0 : i.outerRadius
      const m = t._options || {}
      H.extend(t, {
  ...
  const Wt = H.valueOrDefault
  const Vt = H.options.resolve
  const Ht = H.canvas._isPointInArea
  function jt (t, e) {
    const n = (t && t.options.ticks) || {}
    const i = n.reverse
    const a = void 0 === n.min ? e : 0
    const r = void 0 === n.max ? e : 0
  ...
  const Yt = it.extend({
    ...
    update: function (t) {
      ...
      const r = a.dataset
      const o = a.data || []
      const s = i.chart.options
      const l = i._config
      const u = (i._showLine = Wt(l.showLine, s.showLines))
      for (
    ...
    updateElement: function (t, e, n) {
      ...
      const o = r.getMeta()
      const s = t.custom || {}
      const l = r.getDataset()
      const u = r.index
      const d = l.data[e]
      const h = r._xScale
      const c = r._yScale
      const f = o.dataset._model
      const g = r._resolveDataElementOptions(t, e);
    ...
    _resolveDatasetElementOptions: function (t) {
      ...
      const n = e._config
      const i = t.custom || {}
      const a = e.chart.options
      const r = a.elements.line
      const o = it.prototype._resolveDatasetElementOptions.apply(e, arguments)
      return (
  ...
  const Xt = it.extend({
    ...
    update: function (t) {
      ...
      let i
      const a = this
      const r = a.getDataset()
      const o = a.getMeta()
      let s = a.chart.options.startAngle || 0
      const l = (a._starts = [])
      const u = (a._angles = [])
      const d = o.data
      for (
    ...
    _updateRadius: function () {
      ...
      const n = e.chartArea
      const i = e.options
      const a = Math.min(n.right - n.left, n.bottom - n.top);
    ...
    updateElement: function (t, e, n) {
      ...
      const s = o.animation
      const l = a.scale
      const u = a.data.labels
      const d = l.xCenter
      const h = l.yCenter
      const c = o.startAngle
      const f = t.hidden ? 0 : l.getDistanceFromCenterForValue(r.data[e])
      const g = i._starts[e]
      const p = g + (t.hidden ? 0 : i._angles[e])
      const m = s.animateScale ? 0 : l.getDistanceFromCenterForValue(r.data[e])
      const v = t._options || {}
      H.extend(t, {
        _datasetIndex: i.index,
        _index: e,
  ...
  const $t = it.extend({
    ...
    updateElement: function (t, e, n) {
      ...
      const a = t.custom || {}
      const r = i.getDataset()
      const o = i.chart.scale
      const s = o.getPointPositionForValue(e, r.data[e])
      const l = i._resolveDataElementOptions(t, e)
      const u = i.getMeta().dataset._model
      const d = n ? o.xCenter : s.x
      const h = n ? o.yCenter : s.y;
      (t._scale = o),
      (t._options = l),
      (t._datasetIndex = i.index),
      (t._index = e),
    ...
    _resolveDatasetElementOptions: function () {
      const t = this
      const e = t._config
      const n = t.chart.options
      const i = it.prototype._resolveDatasetElementOptions.apply(t, arguments)
      return (
    ...
    updateBezierControlPoints: function () {
      ...
      let n
      let i
      const a = this.getMeta()
      const r = this.chart.chartArea
      let o = a.data || []
      function s (t, e, n) {
        return Math.max(Math.min(t, n), e)
      }
  ...
  function te (t, e) {
    ...
    let o
    let s
    const l = t._getSortedVisibleDatasetMetas()
  ...
  function ae (t, e, n) {
    ...
    n.axis = n.axis || 'x'
    const a = ie(n.axis)
    const r = n.intersect ? ee(t, i) : ne(t, i, !1, a)
    const o = []
    return r.length
  ...
  const re = {
    modes: {
      ...
      dataset: function (t, e, n) {
        ...
        n.axis = n.axis || 'xy'
        const a = ie(n.axis)
        let r = n.intersect ? ee(t, i) : ne(t, i, !1, a)
        return (
  ...
  const pe = {
    ...
    update: function (t, e, n) {
      if (t) {
        ...
        const a = H.options.toPadding(i.padding)
        const r = e - a.width
        const o = n - a.height
        const s = (function (t) {
          const e = (function (t) {
 ...
 (i = t[e]),
          ...
          const n = le(se(e, 'left'), !0)
          const i = le(se(e, 'right'))
          const a = le(se(e, 'top'), !0)
          const r = le(se(e, 'bottom'))
          return {
  ...
  const me =
      ...
      ge
  const ve = '$chartjs'
  const be = 'chartjs-size-monitor'
  const xe = 'chartjs-render-monitor'
  const ye = 'chartjs-render-animation'
  const _e = ['animationstart', 'webkitAnimationStart']
  const ke = {
  ...
  function De (t, e, n) {
    ...
    let o
    const s = t[ve] || (t[ve] = {})
    const l = (s.resizer = (function (t) {
      const e = Ae(be)
      const n = Ae(be + '-expand')
      const i = Ae(be + '-shrink')
      n.appendChild(Ae()),
      i.appendChild(Ae()),
      e.appendChild(n),
      e.appendChild(i),
    ...
    !(function (t, e) {
      const n = t[ve] || (t[ve] = {})
      const i = (n.renderProxy = function (t) {
  ...
  const Ie = {
    ...
    acquireContext: function (t, e) {
      ...
      return n && n.canvas === t
        ? (this._ensureLoaded(t),
          (function (t, e) {
            const n = t.style
            const i = t.getAttribute('height')
            const a = t.getAttribute('width')
            if (
              ((t[ve] = {
                initial: {
                  height: i,
          ...
          ((a.proxies || (a.proxies = {}))[t.id + '_' + e] = function (e) {
            n(
              (function (t, e) {
                ...
                const i = H.getRelativePosition(t, e)
    ...
    removeEventListener: function (t, e, n) {
      const i = t.canvas
      if (e !== 'resize') {
        const a = ((n[ve] || {}).proxies || {})[t.id + '_' + e]
        a && Ce(i, e, a)
      } else Te(i)
    }
  };
  (H.addEvent = Se), (H.removeEvent = Ce)
  const Fe = Ie._enabled
    ? Ie
    : {
  ...
  const Le = {
    ...
    notify: function (t, e, n) {
      ...
      let o
      let s
      const l = this.descriptors(t)
      const u = l.length
      for (i = 0; i < u; ++i) {
        if (
          typeof (s = (r = (a = l[i]).plugin)[e]) === 'function' &&
    ...
    descriptors: function (t) {
      ...
      const i = []
      const a = (t && t.config) || {}
      const r = (a.options && a.options.plugins) || {}
      return (
  ...
  const ze = H.valueOrDefault
  const Ne = H.rtl.getRtlAdapter
  N._set('global', {
    tooltips: {
      enabled: !0,
      custom: null,
    ...
    nearest: function (t, e) {
      ...
      for (n = 0, i = t.length; n < i; ++n) {
        ...
        if (l && l.hasValue()) {
          ...
          const d = H.distanceBetweenPoints(e, u)
          d < s && ((s = d), (a = l))
        }
      }
      if (a) {
  ...
  const qe = K.extend({
    ...
    getTitle: function () {
      ...
      const e = t._options
      const n = e.callbacks
      const i = n.beforeTitle.apply(t, arguments)
    ...
    update: function (t) {
      ...
      const c = h._options
      const f = h._model
      const g = (h._model = Ve(c))
      const p = h._active
      const m = h._data
      let v = { xAlign: f.xAlign, yAlign: f.yAlign }
      let b = { x: f.x, y: f.y }
      let x = { width: f.width, height: f.height }
      let y = { x: f.caretX, y: f.caretY }
      if (p.length) {
        g.opacity = 1
        const _ = []
        const k = []
        ...
        (x = (function (t, e) {
          ...
          let a = 0
          const r = e.body
          let o = r.reduce(function (t, e) {
            return t + e.before.length + e.lines.length + e.after.length
          }, 0)
          o += e.beforeBody.length + e.afterBody.length
          const s = e.title.length
          const l = e.footer.length
          const u = e.titleFontSize
          const d = e.bodyFontSize
          const h = e.footerFontSize;
          (i += s * u),
        ...
        (b = (function (t, e, n, i) {
          ...
          (v = (function (t, e) {
            ...
            const s = t._model
            const l = t._chart
            const u = t._chart.chartArea
            let d = 'center'
            let h = 'center'
            s.y < e.height
              ? (h = 'top')
              : s.y > l.height - e.height && (h = 'bottom')
            const c = (u.left + u.right) / 2
            const f = (u.top + u.bottom) / 2
            h === 'center'
              ? ((n = function (t) {
                  return t <= c
                }),
    ...
    drawCaret: function (t, e) {
      const n = this._chart.ctx
      const i = this._view
      const a = this.getCaretPosition(t, e, i)
    ...
    drawBody: function (t, e, n) {
      ...
      let u
      let d
      const h = e.bodyFontSize
      const c = e.bodySpacing
      const f = e._bodyAlign
      const g = e.body
      const p = e.displayColors
      let m = 0
      const v = p ? He(e, 'left') : 0
      const b = Ne(e.rtl, e.x, e.width)
      const x = function (e) {
        n.fillText(e, b.x(t.x + m), t.y + h / 2), (t.y += h + c)
      }
      const y = b.textAlign(f)
      for (
        n.textAlign = f,
        n.textBaseline = 'middle',
        ...
        m = p && y !== 'right' ? (f === 'center' ? h / 2 + 1 : h + 2) : 0,
        s = 0,
        u = g.length;
        s < u;
        ++s
    ...
    drawBackground: function (t, e, n, i) {
      ...
      const l = i.width
      const u = i.height
      const d = e.cornerRadius
      n.beginPath(),
      n.moveTo(o + d, s),
      r === 'top' && this.drawCaret(t, i),
      n.lineTo(o + l - d, s),
      n.quadraticCurveTo(o + l, s, o + l, s + d),
      r === 'center' && a === 'right' && this.drawCaret(t, i),
      n.lineTo(o + l, s + u - d),
      n.quadraticCurveTo(o + l, s + u, o + l - d, s + u),
      r === 'bottom' && this.drawCaret(t, i),
      n.lineTo(o + d, s + u),
      n.quadraticCurveTo(o, s + u, o, s + u - d),
      r === 'center' && a === 'left' && this.drawCaret(t, i),
      n.lineTo(o, s + d),
    ...
    draw: function () {
      ...
      if (e.opacity !== 0) {
        ...
        const i = { x: e.x, y: e.y }
        const a = Math.abs(e.opacity < 0.001) ? 0 : e.opacity
        const r =
              e.title.length ||
              e.beforeBody.length ||
              e.body.length ||
      ...
      merger: function (t, e, n, i) {
        if (t === 'xAxes' || t === 'yAxes') {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a) {
            (o = n[t][a]),
            (r = Ge(o.type, t === 'xAxes' ? 'category' : 'linear')),
  ...
  H.extend(tn.prototype, {
    ...
    resize: function (t) {
      ...
      const n = e.options
      const i = e.canvas
      const a = (n.maintainAspectRatio && e.aspectRatio) || null
      const r = Math.max(0, Math.floor(H.getMaximumWidth(i)))
      const o = Math.max(0, Math.floor(a ? r / a : H.getMaximumHeight(i)))
      if (
    ...
    buildOrUpdateScales: function () {
      ...
      const n = t.scales || {}
      let i = []
      const a = Object.keys(n).reduce(function (t, e) {
        return (t[e] = !1), t
      }, {})
      e.scales &&
        (i = i.concat(
    ...
    render: function (t) {
      ...
      const i = Ge(t.duration, n && n.duration)
      const a = t.lazy
      if (!1 !== Le.notify(e, 'beforeRender')) {
        ...
        if (n && i) {
          const o = new $({
            ...
            render: function (t, e) {
              const n = H.easing.effects[e.easing]
              const i = e.currentStep
              const a = i / e.numSteps
              t.draw(n(a), a, i)
            },
    ...
    _drawTooltip: function (t) {
      ...
      const n = { tooltip: e, easingValue: t }
  ...
  const on = {
    formatters: {
      ...
      linear: function (t, e, n) {
        ...
        const a = H.log10(Math.abs(i))
        let r = ''
        if (t !== 0) {
          if (Math.max(Math.abs(n[0]), Math.abs(n[n.length - 1])) < 1e-4) {
            const o = H.log10(Math.abs(t))
            let s = Math.floor(o) - Math.floor(a);
            (s = Math.max(Math.min(s, 20), 0)), (r = t.toExponential(s))
          } else {
            let l = -1 * Math.floor(a);
      ...
      logarithmic: function (t, e, n) {
        const i = t / Math.pow(10, Math.floor(H.log10(t)))
        return t === 0
          ? '0'
  ...
  const sn = H.isArray
  const ln = H.isNullOrUndef
  const un = H.valueOrDefault
  const dn = H.valueAtIndexOrDefault
  function hn (t, e, n) {
    let i
    const a = t.getTicks().length
    const r = Math.min(e, a - 1)
    let o = t.getPixelForTick(r)
    const s = t._startPixel
    const l = t._endPixel
    if (
      !(
        n &&
  ...
  function bn (t, e, n, i) {
    ...
    let s
    const l = un(n, 0)
    const u = Math.min(un(i, t.length), t.length)
    let d = 0
    for (
  ...
  const xn = K.extend({
    ...
    update: function (t, e, n) {
      ...
      let s
      const l = this
      const u = l.options.ticks
      const d = u.sampleSize
      if (
        (l.beforeUpdate(),
        (l.maxWidth = t),
        (l.maxHeight = e),
    ...
    calculateTickRotation: function () {
      ...
      const l = s.options
      const u = l.ticks
      const d = s.getTicks().length
      const h = u.minRotation || 0
      const c = u.maxRotation
      let f = h
    ...
    fit: function () {
      const t = this
      const e = (t.minSize = { width: 0, height: 0 })
      const n = t.chart
      const i = t.options
      const a = i.ticks
      const r = i.scaleLabel
      const o = i.gridLines
      const s = t._isVisible()
      const l = i.position === 'bottom'
      ...
      if (
        ...
        const g = h.widest
        const p = h.highest
        const m = 0.4 * d.minor.lineHeight
        const v = a.padding
        if (u) {
          const b = t.labelRotation !== 0
          const x = H.toRadians(t.labelRotation)
          const y = Math.cos(x)
          const _ = Math.sin(x)
          const k = _ * g.width + y * (p.height - (b ? p.offset : 0)) + (b ? 0 : m)
          e.height = Math.min(t.maxHeight, e.height + k + v)
          let w
          let M
          const S = t.getPixelForTick(0) - t.left
          const C = t.right - t.getPixelForTick(t.getTicks().length - 1)
          b
          ...
          const P = a.mirror ? 0 : g.width + v + m;
    ...
    _autoSkip: function (t) {
      ...
      const s = r.maxTicksLimit || o / this._tickSize() + 1
      const l = r.major.enabled
        ? (function (t) {
            let e
            let n
            const i = []
    ...
    _tickSize: function () {
      const t = this.options.ticks
      const e = H.toRadians(this.labelRotation)
      const n = Math.abs(Math.cos(e))
      const i = Math.abs(Math.sin(e))
      const a = this._getLabelSizes()
      const r = t.autoSkipPadding || 0
      const o = a ? a.widest.width + r : 0
      const s = a ? a.highest.height + r : 0
    ...
    _computeGridLineItems: function (t) {
      ...
      const _ = y.gridLines
      const k = y.position
      const w = _.offsetGridLines
      const M = b.isHorizontal()
      const S = b._ticksToDraw
      const C = S.length + (w ? 1 : 0)
      const P = fn(_)
      const A = []
      const D = _.drawBorder ? dn(_.lineWidth, 0, 0) : 0
      const T = D / 2
      const I = H._alignPixel
      const F = function (t) {
        return I(x, t, D)
      }
      for (
    ...
    _computeLabelItems: function () {
      ...
      const b = c._ticksToDraw
      const x = mn(g)
      const y = g.padding
      const _ = fn(f.gridLines)
      const k = -H.toRadians(c.labelRotation)
      const w = []
      for (
        p === 'top'
    ...
    _drawGrid: function (t) {
      ...
      if (n.display) {
        ...
        const l = e.ctx
        const u = e.chart
        const d = H._alignPixel
        const h = n.drawBorder ? dn(n.lineWidth, 0, 0) : 0
        const c =
        ...
        if (h) {
          ...
          let m
          const v = h
          const b = dn(n.lineWidth, c.ticksLength - 1, 1)
          const x = c.borderValue
          e.isHorizontal()
            ? ((f = d(u, e.left, v) - v / 2),
              (g = d(u, e.right, b) + b / 2),
              (p = m = x))
    ...
    _drawLabels: function () {
      ...
      if (t.options.ticks.display) {
        ...
        let l
        const u = t.ctx
        const d = t._labelItems || (t._labelItems = t._computeLabelItems())
    ...
    _drawTitle: function () {
      ...
      const e = t.ctx
      const n = t.options
      const i = n.scaleLabel
      if (i.display) {
        let a
        let r
        const o = un(i.fontColor, N.global.defaultFontColor)
        const s = H.options._parseFont(i)
        const l = H.options.toPadding(i.padding)
        const u = s.lineHeight / 2
        const d = n.position
        let h = 0
        if (t.isHorizontal()) {
          (a = t.left + t.width / 2),
          (r = d === 'bottom' ? t.bottom - u - l.bottom : t.top + u + l.top)
        } else {
          const c = d === 'left';
    ...
    _layers: function () {
      const t = this
      const e = t.options
      const n = (e.ticks && e.ticks.z) || 0
      const i = (e.gridLines && e.gridLines.z) || 0
  ...
  const yn = xn
  const _n = H.isNullOrUndef
  const kn = yn.extend({
    determineDataLimits: function () {
      let t
      const e = this
      const n = e._getLabels()
  ...
  const wn = { position: 'bottom' }
  kn._defaults = wn
  const Mn = H.noop
  const Sn = H.isNullOrUndef
  const Cn = yn.extend({
    getRightValue: function (t) {
    ...
    handleTickRangeOptions: function () {
      ...
      if (e.beginAtZero) {
        const n = H.sign(t.min)
        const i = H.sign(t.max)
        n < 0 && i < 0 ? (t.max = 0) : n > 0 && i > 0 && (t.min = 0)
      }
      const a = void 0 !== e.min || void 0 !== e.suggestedMin
      const r = void 0 !== e.max || void 0 !== e.suggestedMax
      void 0 !== e.min
        ? (t.min = e.min)
    ...
    buildTicks: function () {
      ...
      const a = (t.ticks = (function (t, e) {
        ...
        const s = t.stepSize
        const l = s || 1
        const u = t.maxTicks - 1
        const d = t.min
        const h = t.max
        const c = t.precision
        const f = e.min
        const g = e.max
        let p = H.niceNum((g - f) / u / l) * l
        ...
        (a = Math.round(a * n) / n),
        o.push(Sn(d) ? i : d)
        for (let m = 1; m < r; ++m) o.push(Math.round((i + m * p) * n) / n)
  ...
  const Pn = { position: 'left', ticks: { callback: on.formatters.linear } }
  function An (t, e, n, i) {
    let a
    let r
    const o = t.options
  ...
  const Tn = Cn.extend({
    determineDataLimits: function () {
      ...
      const a = this
      const r = a.options
      const o = a.chart.data.datasets
      const s = a._getMatchingVisibleMetas()
      let l = r.stacked
      const u = {}
      const d = s.length
      if (
  ...
  const In = Pn
  Tn._defaults = In
  const Fn = H.valueOrDefault
  const On = H.math.log10
  const Ln = { position: 'left', ticks: { callback: on.formatters.logarithmic } }
  function Rn (t, e) {
  ...
  const zn = yn.extend({
      ...
      if (s.stacked || c) {
        ...
        for (t = 0; t < u.length; t++) {
          if (((e = l.getDatasetMeta(t)), l.isDatasetVisible(t) && h(e))) {
            for (a = 0, r = (i = u[t].data).length; a < r; a++) { (n = o._parseValue(i[a])),
            isNaN(n.min) ||
                    isNaN(n.max) ||
                    e.data[a].hidden ||
                    n.min < 0 ||
    ...
    handleTickRangeOptions: function () {
      ...
      t.min === t.max &&
            (t.min !== 0 && t.min !== null
              ...
              : ((t.min = 1), (t.max = 10))),
      t.min === null && (t.min = Math.pow(10, Math.floor(On(t.max)) - 1)),
      t.max === null &&
            (t.max =
              t.min !== 0 ? Math.pow(10, Math.floor(On(t.min)) + 1) : 10),
      t.minNotZero === null &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
    ...
    buildTicks: function () {
      ...
      const i = { min: Rn(e.min), max: Rn(e.max) }
      const a = (t.ticks = (function (t, e) {
        let n
        let i
        const a = []
        let r = Fn(t.min, Math.pow(10, Math.floor(On(e.min))))
        const o = Math.floor(On(e.max))
        const s = Math.ceil(e.max / Math.pow(10, o))
        r === 0
    ...
    getValueForPixel: function (t) {
      const e = this
      const n = e.getDecimalForPixel(t)
      return n === 0 && e.min === 0
        ? 0
  ...
  const Nn = Ln
  zn._defaults = Nn
  const Bn = H.valueOrDefault
  const En = H.valueAtIndexOrDefault
  const Wn = H.options.resolve
  const Vn = {
    display: !0,
    animate: !0,
    position: 'chartArea',
  ...
  const Xn = Cn.extend({
    ...
    convertTicksToLabels: function () {
      ...
      (t.pointLabels = t.chart.data.labels.map(function () {
        const e = H.callback(t.options.pointLabels.callback, arguments, t)
        return e || e === 0 ? e : ''
      }))
    },
    getLabelForIndex: function (t, e) {
    ...
    fit: function () {
      ...
      t.display && t.pointLabels.display
        ? (function (t) {
            ...
            let n
            let i
            const a = H.options._parseFont(t.options.pointLabels)
            const r = { l: 0, r: t.width, t: 0, b: t.height - t.paddingTop }
            const o = {};
            (t.ctx.font = a.string), (t._pointLabelSizes = [])
            let s
            let l
            let u
            const d = t.chart.data.labels.length
            for (e = 0; e < d; e++) {
              ...
              const h = t.getIndexAngle(e)
              const c = H.toDegrees(h) % 360
              const f = jn(c, i.x, n.w, 0, 180)
              const g = jn(c, i.y, n.h, 90, 270)
    ...
    setReductions: function (t, e, n) {
      const i = this
      let a = e.l / Math.sin(n.l)
      let r = Math.max(e.r - i.width, 0) / Math.sin(n.r)
      let o = -e.t / Math.cos(n.t)
      let s = -Math.max(e.b - (i.height - i.paddingTop), 0) / Math.cos(n.b);
      (a = Gn(a)),
      (r = Gn(r)),
      (o = Gn(o)),
      (s = Gn(s)),
    ...
    setCenterPoint: function (t, e, n, i) {
      const a = this
      const r = a.width - e - a.drawingArea
      const o = t + a.drawingArea
      const s = n + a.drawingArea
      const l = a.height - a.paddingTop - i - a.drawingArea;
    ...
    _drawGrid: function () {
      ...
      const r = i.options
      const o = r.gridLines
      const s = r.angleLines
      const l = Bn(s.lineWidth, o.lineWidth)
      const u = Bn(s.color, o.color)
      if (
        (r.pointLabels.display &&
            (function (t) {
              const e = t.ctx
              const n = t.options
              const i = n.pointLabels
              const a = Hn(n)
              const r = t.getDistanceFromCenterForValue(
                n.ticks.reverse ? t.min : t.max
              )
              const o = H.options._parseFont(i)
              e.save(), (e.font = o.string), (e.textBaseline = 'middle')
              for (let s = t.chart.data.labels.length - 1; s >= 0; s--) {
                const l = s === 0 ? a / 2 : 0
                const u = t.getPointPosition(s, r + l + 5)
                const d = En(i.fontColor, s, N.global.defaultFontColor)
                e.fillStyle = d
                const h = t.getIndexAngle(s)
                const c = H.toDegrees(h);
                (e.textAlign = qn(c)),
            ...
            H.each(i.ticks, function (t, n) {
              n !== 0 &&
                ...
                (function (t, e, n, i) {
                  ...
                  const r = t.ctx
                  const o = e.circular
                  const s = t.chart.data.labels.length
                  const l = En(e.color, i - 1)
                  const u = En(e.lineWidth, i - 1)
                  if ((o || s) && l && u) {
                    if (
                      (r.save(),
                      (r.strokeStyle = l),
    ...
    _drawLabels: function () {
      ...
      if (n.display) {
        ...
        const o = H.options._parseFont(n)
        const s = Bn(n.fontColor, N.global.defaultFontColor)
        e.save(),
        (e.font = o.string),
  ...
  const Kn = Vn
  Xn._defaults = Kn
  const Zn = H._deprecated
  const $n = H.options.resolve
  const Jn = H.valueOrDefault
  const Qn = Number.MIN_SAFE_INTEGER || -9007199254740991
  const ti = Number.MAX_SAFE_INTEGER || 9007199254740991
  const ei = {
  ...
  function oi (t, e, n, i) {
    ...
    const r = a.lo ? (a.hi ? a.lo : t[t.length - 2]) : t[0]
    const o = a.lo ? (a.hi ? a.hi : t[t.length - 1]) : t[1]
    const s = o[e] - r[e]
    const l = s ? (n - r[e]) / s : 0
    const u = (o[i] - r[i]) * l
    return r[i] + u
  ...
  function si (t, e) {
    ...
    return (
      ...
      H.isFinite(o) || (o = typeof r === 'string' ? n.parse(o, r) : n.parse(o)),
      o !== null
        ? +o
        : (a ||
            typeof r !== 'function' ||
  ...
  function di (t, e, n) {
    ...
    return s !== 0 && n
      ? (function (t, e, n, i) {
          ...
          let r
          const o = t._adapter
          const s = +o.startOf(e[0].value, i)
          const l = e[e.length - 1].value
  ...
  const hi = yn.extend({
    ...
    update: function () {
      ...
      const i = (t._adapter = new rn._date(e.adapters.date))
      return (
    ...
    determineDataLimits: function () {
      ...
      const u = s._adapter
      const d = s.options
      const h = d.time.unit || 'day'
      let c = ti
      let f = Qn
      let g = []
      const p = []
      const m = []
      const v = s._getLabels()
    ...
    buildTicks: function () {
      ...
      let u = i._timestamps
      const d = []
      const h = i.getLabelCapacity(a)
      const c = s.source
      const f = o.distribution
      for (
        u =
            c === 'data' || (c === 'auto' && f === 'series')
              ...
              : c === 'labels'
                ...
                : (function (t, e, n, i) {
                    ...
                    const o = t.options
                    const s = o.time
                    const l = s.unit || ui(s.minUnit, e, n, i)
                    const u = $n([s.stepSize, s.unitStepSize, 1])
                    const d = l === 'week' && s.isoWeekday
                    let h = e
                    const c = []
                    if (
      ...
      return (
        ...
        (i._majorUnit =
            s.major.enabled && i._unit !== 'year'
              ? (function (t) {
                  for (let e = ni.indexOf(t) + 1, n = ni.length; e < n; ++e) { if (ei[ni[e]].common) return ni[e] }
                })(i._unit)
              : void 0),
    ...
    getLabelForIndex: function (t, e) {
      const n = this
      const i = n._adapter
      const a = n.chart.data
      const r = n.options.time
      let o = a.labels && t < a.labels.length ? a.labels[t] : ''
      const s = a.datasets[e].data[t]
      return (
    ...
    tickFormatFunction: function (t, e, n, i) {
      ...
      const s = o[this._unit]
      const l = this._majorUnit
      const u = o[l]
      const d = n[e]
      const h = r.ticks
      const c = l && u && d && d.major
      const f = a.format(t, i || (c ? u : s))
      const g = c ? h.major : h.minor
      const p = $n([g.callback, g.userCallback, h.callback, h.userCallback])
      return p ? p(f, e, n) : f
    },
    ...
    getPixelForOffset: function (t) {
      ...
      const n = oi(this._table, 'time', t, 'pos')
    ...
    getValueForPixel: function (t) {
      const e = this._offsets
      const n = this.getDecimalForPixel(t) / e.factor - e.end
      const i = oi(this._table, 'pos', n, 'time')
      return this._adapter._create(i)
    },
    _getLabelSize: function (t) {
      const e = this.options.ticks
      const n = this.ctx.measureText(t).width
      const i = H.toRadians(this.isHorizontal() ? e.maxRotation : e.minRotation)
      const a = Math.cos(i)
      const r = Math.sin(i)
      const o = Jn(e.fontSize, N.global.defaultFontSize)
    ...
    getLabelCapacity: function (t) {
      ...
      const i = n.displayFormats
      const a = i[n.unit] || i.millisecond
      const r = e.tickFormatFunction(t, 0, di(e, [t], e._majorUnit), a)
      const o = e._getLabelSize(r)
      let s = Math.floor(e.isHorizontal() ? e.width / o.w : e.height / o.h)
  ...
  const pi = {
    dataset: function (t) {
      ...
      const a = (i && n.isDatasetVisible(e) && i.dataset._children) || []
      const r = a.length || 0
      return r
        ? function (t, e) {
  ...
  function vi (t) {
    return (t.el._scale || {}).getPointPositionForValue
      ? (function (t) {
          ...
          const o = t.el._scale
          const s = o.options
          const l = o.chart.data.labels.length
          const u = t.fill
          const d = []
          if (!l) return null
          for (
  ...
  const Mi = H.rtl.getRtlAdapter
  const Si = H.noop
  const Ci = H.valueOrDefault
  function Pi (t, e) {
    ...
    legend: {
      ...
      labels: {
        ...
        generateLabels: function (t) {
          ...
          const n = t.options.legend || {}
          const i = n.labels && n.labels.usePointStyle
  ...
  const Ai = K.extend({
    ...
    buildLabels: function () {
      ...
      let n = H.callback(e.generateLabels, [t.chart], t) || []
      e.filter &&
    ...
    fit: function () {
      ...
      const i = e.display
      const a = t.ctx
      const r = H.options._parseFont(n)
      const o = r.size
      const s = (t.legendHitBoxes = [])
      const l = t.minSize
      const u = t.isHorizontal()
      if (
        (u
        ...
        if (((a.font = r.string), u)) {
          ...
          H.each(t.legendItems, function (t, e) {
            const i = Pi(n, o) + o / 2 + a.measureText(t.text).width;
          ...
          const c = n.padding
          const f = (t.columnWidths = [])
          const g = (t.columnHeights = [])
          let p = n.padding
          let m = 0
          let v = 0
          H.each(t.legendItems, function (t, e) {
    ...
    draw: function () {
      ...
      const n = e.labels
      const i = N.global
      const a = i.defaultColor
      const r = i.elements.line
      const o = t.height
      const s = t.columnHeights
      const l = t.width
      const u = t.lineWidths
      if (e.display) {
        let d
        const h = Mi(e.rtl, t.left, t.minSize.width)
        const c = t.ctx
        const f = Ci(n.fontColor, i.defaultFontColor)
        const g = H.options._parseFont(n)
        const p = g.size;
        ...
        H.each(t.legendItems, function (e, i) {
          ...
          !(function (t, e, i) {
            if (!(isNaN(m) || m <= 0)) {
              c.save()
              const o = Ci(i.lineWidth, r.borderWidth)
              if (
    ...
    handleEvent: function (t) {
      ...
      const n = this
      const i = n.options
      const a = t.type === 'mouseup' ? 'click' : t.type
      if (a === 'mousemove') {
  ...
  function Di (t, e) {
    const n = new Ai({ ctx: t.ctx, options: e, chart: t })
  ...
  const Fi = K.extend({
    ...
    draw: function () {
      ...
      if (n.display) {
        ...
        const g = n.text
        if (H.isArray(g)) {
          for (let p = 0, m = 0; m < g.length; ++m) { e.fillText(g[m], 0, p, i), (p += s) }
  ...
  function Oi (t, e) {
    const n = new Fi({ ctx: t.ctx, options: e, chart: t })
  ...
  (function () {
    ...
    function n (n, i, a) {
      ...
      const o = H._getParentNode(n)
      const s = r.getComputedStyle(n)[i]
      const l = r.getComputedStyle(o)[i]
      const u = e(s)
      const d = e(l)
      const h = Number.POSITIVE_INFINITY
    ...
    (H.splineCurve = function (t, e, n, i) {
      ...
      const r = e
      const o = n.skip ? e : n
      const s = Math.sqrt(Math.pow(r.x - a.x, 2) + Math.pow(r.y - a.y, 2))
      const l = Math.sqrt(Math.pow(o.x - r.x, 2) + Math.pow(o.y - r.y, 2))
      let u = s / (s + l)
      let d = l / (s + l)
      const h = i * (u = isNaN(u) ? 0 : u)
      const c = i * (d = isNaN(d) ? 0 : d)
      return {
    ...
    (H.niceNum = function (t, e) {
      const n = Math.floor(H.log10(t))
      const i = t / Math.pow(10, n)
      return (
        (e
          ? i < 1.5
            ? 1
    ...
    (H.getRelativePosition = function (t, e) {
      let n
      let i
      const a = t.originalEvent || t
      const r = t.target || t.srcElement
      const o = r.getBoundingClientRect()
      const s = a.touches
      s && s.length > 0
        ? ((n = s[0].clientX), (i = s[0].clientY))
        : ((n = a.clientX), (i = a.clientY))
      const l = parseFloat(H.getStyle(r, 'padding-left'))
      const u = parseFloat(H.getStyle(r, 'padding-top'))
      const d = parseFloat(H.getStyle(r, 'padding-right'))
      const h = parseFloat(H.getStyle(r, 'padding-bottom'))
      const c = o.right - o.left - l - d
      const f = o.bottom - o.top - u - h
      return {
        x: (n = Math.round(
    ...
    (H.getMaximumWidth = function (t) {
      ...
      const a = H.getConstraintWidth(t)
    ...
    (H.getMaximumHeight = function (t) {
      ...
      const a = H.getConstraintHeight(t)
      return isNaN(a) ? i : Math.min(i, a)
    }),
    ...
    (H.longestText = function (t, e, n, i) {
      ...
      const c = n.length
      for (o = 0; o < c; o++) {
        if ((u = n[o]) != null && !0 !== H.isArray(u)) { h = H.measureText(t, a, r, h, u) } else if (H.isArray(u)) {
  ...
  const Ei = en
  return (
    typeof window !== 'undefined' && (window.Chart = en),
    (en.Chart = en),
